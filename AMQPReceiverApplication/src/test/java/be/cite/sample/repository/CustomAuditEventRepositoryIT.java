...
import be.cite.sample.config.Constants;
import be.cite.sample.config.TestSecurityConfiguration;
import be.cite.sample.config.audit.AuditEventConverter;
import be.cite.sample.domain.PersistentAuditEvent;
...
import static be.cite.sample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
